...
import emptyCard from '../assets/img/empty.png'
            ...
            {totalCount?<div className="cart">
              ...
              <span>
                ...
                <div className="cart cart--empty">
                    ...
                    <p>
                        Вероятней всего, вы не заказывали ещё карту.
                        <br />
                        Для того, чтобы заказать карту, перейди на главную страницу.
                    </p>
                    <img src={emptyCard} alt="Empty cart" className='empty-img' />
